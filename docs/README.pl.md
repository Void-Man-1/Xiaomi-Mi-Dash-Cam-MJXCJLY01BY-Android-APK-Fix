# Xiaomi Mi Dash Cam MJXCJLY01BY — APK dla Android 8.1–16
...
**[Pobierz Mi-Dash-Cam-EU-2.0.0-android12-16-arm64.apk](https://github.com/Void-Man-1/Mi-Dash-cam-Android-8.1-16-fix-MJXCJLY01BY/releases/download/v2.0.0/Mi-Dash-Cam-EU-2.0.0-android12-16-arm64.apk)**
...
Jeżeli aplikacja nie instaluje się, nie łączy przez Wi-Fi, pokazuje czarny ekran albo się zawiesza, zobacz [przewodnik rozwiązywania problemów](TROUBLESHOOTING.md).
